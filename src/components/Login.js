...
import { authenticate, isAuthenticated, managerLogin } from "./ApiCalls";
...
const Login = () => {
	...
	const loginManager = async (e) => {
		...
		const response = await managerLogin(loginDetails);
							...
							<div className="card-body p-md-5">
								<div className="row justify-content-center">
									<div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
										...
										<form className="mx-1 mx-md-4" onSubmit={loginManager}>
